...
\---
layout: post
title: "MapSlim & SetSlim - From DictionarySlim to Fsion"
tags: [mapslim,setslim,listslim,dictionaryslim,fsiom]
description: "MapSlim & SetSlim - From DictionarySlim to Fsion"
...
To do this it returns `ref` values and has a more efficient way of using the hash values. It came from ideas used in the
[Benchmarks Game](https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/knucleotide-csharpcore-9.html).

[Fsion](https://github.com/AnthonyLloyd/Fsion) is a new [WIP](https://dictionary.cambridge.org/dictionary/english/wip) F# bi-temporal database.
...
By creating lock free for read collections this locking can be simplified to fully lock free for read access.
