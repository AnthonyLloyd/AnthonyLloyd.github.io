...
It is designed as a library to be used in a testing exe project instead of code written to run inside a framework.
...
By backing up and choosing a simpler evolutionary path its hoped the library can go further than current testing frameworks.
...
It has the advantage of not needing any code generation or reflection code.
...
There is a little pressure from the community to get something in after it was announced that C# was exploring adding type classes.
